...
if (($_POST['username'] != NULL) || ($_POST['username_reg'] != NULL)) {
    ...
    if ($_POST['action'] == 'Регистрация') {
        ...
        $email = htmlspecialchars($_POST['soap']);
        ...
        if (($passconf1 == $passconf2) && ($a == 0)) {
            ...
            $sql = 'Insert into user_db(name,pass, email, red) values(:name,:pass,:email,0);';
            ...
            if ($a) {
                ...
                echo $passconf1, 'Insert into user_db(name,pass, email) values(:name,:pass,:email);' ;
